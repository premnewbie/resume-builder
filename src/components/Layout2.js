  ...
  return (
    <div className="layout-2">
      ...
      {contextData.infosFilled[0] && (
        <section className="personalInfo">
          <div>
            <p>
              <strong>Email: </strong>
              {contextData.userData.personalInfo.email}
            </p>
            <p>
              <strong>Phone: </strong>
              {contextData.userData.personalInfo.phone}
            </p>
            <p>
              <strong>LinkedIn: </strong>
              {contextData.userData.personalInfo.linkedIn}
            </p>
            <p>
              <strong>Github: </strong>
              {contextData.userData.personalInfo.github}
            </p>
          </div>
        </section>
      )}
      {contextData.infosFilled[0] && (
        ...
        >
          <h3>SKills: </h3>
          {contextData.userData.skills?.map((skill) => skill)}
        </section>
      )}
